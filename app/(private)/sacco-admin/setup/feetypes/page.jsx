            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-semibold text-slate-900 flex items-center gap-2">
                            <BadgePercent className="w-6 h-6 text-[var(--accent)]" /> Fee Management Setup
                        </h1>
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        className="bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-white text-xs  shadow-sm"
                    >
                                                ...
                                                <TableRow key={fee.reference}>
                                                    ...
                                                    <TableCell>
                                                        <Button
                                                            variant="ghost"
                                                            size="icon"
                                                            className="h-8 w-8 text-slate-300 hover:text-[var(--accent)] hover:bg-white rounded transition-all border border-transparent hover:border-slate-200 shadow-none"
                                                            onClick={() => {
                                                                setSelectedFee(fee);
